...
if (!function_exists('portfoliosSection')) {
    function portfoliosSection($currentLang, $version) {
        ...
        if ($version == 'lawyer') {
            ...
            foreach ($portfolios as $key => $portfolio) {
                $portfoliosSec .= "<div class='single-case single-case-bg-1 lazy' data-bg='" . url('assets/frontend/images/portfolios/featured/' . $portfolio->featured_image) . "'>
    ...
    function blogsSection($currentLang, $version) {
        ...
        if ($version == 'lawyer') {
            ...
            foreach ($blogs as $key => $blog) {
                ...
                <div class='grid_inner_item'>
                <div class='lawyer_img'>
                <a href='" . route('front.blogdetails', [$blog->slug]) . "'><img data-src='" . url('assets/frontend/images/blogs/' . $blog->main_image) . "' class='img-fluid lazy' alt=''></a>
                </div>
                <div class='lawyer_content'>
                <div class='post_meta'>";
            ...
            foreach ($blogs as $key => $blog) {
                ...
                <img src='" . url('assets/frontend/images/blogs/' . $blog->main_image) . "' alt=''>
                </div>
                <div class='blog-txt'>";
