                     ...
                     <table class="table table-striped mt-3" id="basic-datatables">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              @endphp
                              <td><img src="{{(!empty($images)) ? asset('/assets/frontend/images/events/sliders/'.$images[0]) : ''}}" alt="" width="80"></td>
         ...
         <div class="modal-body">
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.event.store')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <select id="bcategory" class="form-control" name="cat_id" required>
       ...
       $("#upload-video").on('change',function (event){
           ...
           $.ajax({
               ...
               success: function(data) {
                   ...
                   var url = '{{ asset("assets/frontend/img/events/videos/filename") }}';
