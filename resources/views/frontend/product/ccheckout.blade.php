...
@section('content')
  ...
  <section class="checkout-area">
    <form action="{{ route('product.paystack.submit') }}" method="POST" id="payment" enctype="multipart/form-data" class="product_form">
      @csrf
                ...
                <div id="cartTotal">
                  <ul class="cart-total-table">
                    ...
                    <li class="clearfix">
                      ...
                      <span class="col">
                        GHs<span
                          data="{{ cartSubTotal() + $scharge }}"
                          class="grandTotal">{{ cartSubTotal() + $scharge }}</span></span>
                    </li>
