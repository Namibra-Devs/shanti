  ...
  <div class="container">
      ...
      <div class="row my-5 justify-content-around">
          ...
          <div class="col-lg-5 col-11">
              <img src="{{ asset('assets/frontend/images/product/ringbig.png') }}" alt="" class="img-fluid w-100 mb-2">
              <div class="d-flex gap-2">
                  <img src="{{ asset('assets/frontend/images/product/ringsmall.png') }}" alt="" class="img-fluid w-100">
                  <img src="{{ asset('assets/frontend/images/product/ringsmall.png') }}" alt="" class="img-fluid w-100">
              </div>
          </div>
          <div class="col-lg-5 col-11">
              <div class="d-none d-lg-block">
                  <a href="./rings.html" class="mb-4 text-decoration-none text-dark text-uppercase">
                      <img src="{{ asset('assets/frontend/images/back.svg') }}" alt="Back Button" />
                      Back</a>
                  <h3 class="display-3 header-ff">Wedding Ring</h3>
              </div>
              <div class="gender-matrials mt-4 body-ff">
                  <p class="text-muted py-1 m-0"><img src="./src/images/material.svg" alt=""
                          class="me-1 p-0"> Material: Silver</p>
                  <p class="text-muted py-1 m-0"><img src="./src/images/gender.svg" alt=""
                          class="me-1 m-0"> Gender: Unisex</p>

                  <p class="text-muted my-3">Dynamic and elusive abstraction and texture. Plays between the lines
                      of chaos and serenity. Perfect fit for modern and contemporary styled interiors.
                      Dynamic and elusive abstraction and texture. Plays between the lines of chaos and serenity.
                      Perfect fit for modern and contemporary styled interiors.</p>
              </div>

              <div class="d-flex counter-size justify-content-between align-content-center">
                  <div class="">
                      <div class="btn-group text-muted">SIZE:
                          <button type="button" class="btn p-0 ms-2 text-muted border-0"
                              data-bs-toggle="dropdown" aria-expanded="false">
                              7.5 <img src="./src/images/arrow-down.svg" alt="" class="ms-1">
                          </button>
                      ...
                      <div class="btn-group text-muted d-block mt-2">COLOUR:
                          <button type="button" class="btn p-0 ms-2 text-muted border-0"
                              data-bs-toggle="dropdown" aria-expanded="false">
                              Silver <img src="./src/images/arrow-down.svg" alt="" class="ms-1">
                          </button>
                          <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="#">7</a></li>
                              <li><a class="dropdown-item" href="#">6.5</a></li>
              ...
              <div class="d-flex justify-content-between align-content-center my-4">
                  <div class="prices">
                      <p class="m-0 fw-bold">₵ <span class="price">2,499.00</span></p>
                  </div>

                  <div class="stocks me-5 pe-md-3 p-0">
                      <p class="m-0 price text-muted">In Stock: <span>3</span></p>
                  </div>
              </div>
              ...
              <div class="action-btns d-flex justify-content-between align-content-center">
                  ...
                  <div class="">
                      <button class="btn text-uppercase btn-dark px-4 px-md-5 border-2 buy">Buy now</button>
                  </div>
                  <div class="">
                      <button
