                ...
                <div class="col-lg-3 col-md-6">
                    <div class="shop-dropdown mt-30 text-right">
                        <select name="type" id="type_sort">
                            ...
                            <option value="hight-to-low" {{ request()->input('type') == 'high-to-low' ? 'selected' : '' }}>
                            ...
                            <div class="category-item">
                                <ul>
                                    <li class="{{ request()->input('category_id') == '' ? 'active-search' : '' }}"><a
                                            data-href="0" class="category-id cursor-pointer">{{ __('All') }}</a></li>
                                    ...
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            ...
                                            <ul>
                                                ...
                                                <li><a class="cart-link" data-href="{{ route('add.cart', $product->id) }}"
                                                        data-toggle="tooltip" data-placement="top"
