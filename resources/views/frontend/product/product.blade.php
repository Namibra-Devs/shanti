        ...
        <div class="container my-5 pt-lg-5">
            <div class="mt-5 pt-5">
                <p class="text-center text-muted header-ff d-none d-lg-block"><a href=""
                        ...
                        class="active text-decoration-none text-dark">Collections</a></p>
                <h2 class="text-center header">Collections</h2>
                ...
                @foreach ($products as $product)
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="item">
                                    <img src="{{asset('assets/frontend/images/product/featured/'.$product->feature_image)}}" alt="image" class="w-100" />
