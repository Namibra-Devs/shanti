...
<main role="main" class="container mt-4">
  ...
  <div class="container my-5 pt-lg-4">
      <div class="mt-5 pt-5">
          <p class="text-center text-muted eader-ff d-none d-lg-block"><a href=""
                  class="text-decoration-none text-muted">Home</a> / <a href=""
                  class="active text-decoration-none text-dark">Wishlist</a></p>
          <h2 class="text-center header">Wishlist</h2>
                  ...
                  <div class="card-body">
                      <div class="item">
                          ...
                          <div class="mt-2 d-flex justify-content-between align-content-center my-2">
                              ...
                              <div>
                                  <button class="btn"><img src="./src/images/blackheart.svg"
                                          alt=""></button>
                              </div>
                          </div>
                      </div>
